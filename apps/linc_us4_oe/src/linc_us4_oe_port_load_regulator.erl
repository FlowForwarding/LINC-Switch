...
-module(linc_us4_oe_port_load_regulator).
...
%%
%% This function is called by an linc_us4_oe_port while receiving a periodic
...
%%
%% to block input, an appropriate state is set for linc_us4_oe_port, so that
