...
route(#linc_pkt{switch_id = SwitchId} = Pkt, TableId) ->
    FlowEntries = linc_us5_flow:get_flow_table(SwitchId, TableId),
        ...
        table_miss ->
            ...
            case linc_us5_flow:get_table_config(SwitchId, TableId) of
                drop ->
                    {table_miss, drop};
                controller ->
                    linc_us5_port:send(Pkt2, controller),
...
match_flow_entries(#linc_pkt{switch_id = SwitchId}, TableId, []) ->
    linc_us5_flow:update_lookup_counter(SwitchId, TableId),
    table_miss.
...
match_flow_entry(#linc_pkt{switch_id = SwitchId} = Pkt, TableId, FlowEntry) ->
    case pkt_fields_match_flow_fields(Pkt#linc_pkt.fields#ofp_match.fields,
        ...
        false ->
            nomatch;
        true ->
            linc_us5_flow:update_match_counters(SwitchId, TableId,
