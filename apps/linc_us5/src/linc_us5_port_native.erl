...
%% linc_us5_port_procket.erl:7: Function send/2 has no local return
%% linc_us5_port_procket.erl:11: Function close/1 has no local return
...
%% linc_us5_port.erl:446: Function bpf_raw_socket/1 has no local return
%% warnings in dialyzer.
...
%% linc_us5_port.erl:462: Function linux_raw_socket/1 has no local return
%% warnings in dialyzer.
