...
init(SwitchId) ->
    linc:register(SwitchId, linc_us5_queue_sup, self()),
    ChildSpec = {linc_us5_queue, {linc_us5_queue, start_link, [SwitchId]},
                 transient, 5000, worker, [linc_us5_queue]},
