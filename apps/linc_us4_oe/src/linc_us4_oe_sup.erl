...
start_backend_sup(SwitchId) ->
    ...
    %% linc_us4_oe_sup, and linc_us4_oe tries to add another linc_us4_oe_sup.
...
init(SwitchId) ->
    linc:register(SwitchId, linc_us4_oe_sup, self()),
    MeterSup = {linc_us4_oe_meter_sup,
                {linc_us4_oe_meter_sup, start_link, [SwitchId]},
                permanent, 5000, supervisor, [linc_us4_oe_meter_sup]},
    PortSup = {linc_us4_oe_port_sup,
               {linc_us4_oe_port_sup, start_link, [SwitchId]},
               permanent, 5000, supervisor, [linc_us4_oe_port_sup]},
