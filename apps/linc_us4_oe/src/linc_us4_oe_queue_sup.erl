...
init(SwitchId) ->
    linc:register(SwitchId, linc_us4_oe_queue_sup, self()),
    ChildSpec = {linc_us4_oe_queue, {linc_us4_oe_queue, start_link, [SwitchId]},
                 transient, 5000, worker, [linc_us4_oe_queue]},
