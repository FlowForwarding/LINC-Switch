...
add_non_overlapping_flows(Flags) ->
    ...
    [#flow_entry{match=GotMatch1, instructions=GotInstructions1},
     #flow_entry{match=GotMatch2, instructions=GotInstructions2}]=linc_us3_flow:get_flow_table(TableId),
...
modify_strict(Flags) ->
    ...
    %% Modify flow
    ?assertEqual(ok, linc_us3_flow:modify(FlowMod)),
...
delete_all_tables() ->
    ...
    ?assertMatch([#flow_entry{}], linc_us3_flow:get_flow_table(2)),
