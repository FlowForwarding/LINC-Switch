...
%% @copyright 2012 FlowForwarding.org
-module(linc_us4_oe_table_features_tests).
...
get_table_features() ->
    ...
    ?assertMatch(#ofp_table_features_reply{}, linc_us4_oe_table_features:handle_req(0, Req)).
...
set_missing_feature() ->
    ...
    ?assertMatch(#ofp_error_msg{ type=table_features_failed, code=bad_argument },
                 linc_us4_oe_table_features:handle_req(0, Req)).
