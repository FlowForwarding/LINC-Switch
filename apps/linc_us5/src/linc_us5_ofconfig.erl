...
set_port_features(SwitchId, PortNo, Features) ->
    ...
    linc_us5_port:set_advertised_features(SwitchId, PortNo, Features2).
...
set_port_config(SwitchId, PortNo, Config) ->
    ...
    linc_us5_port:set_config(SwitchId, PortNo, Config2).
...
set_queue_min_rate(SwitchId, PortNo, QueueId, MinRate) ->
    linc_us5_queue:set_min_rate(SwitchId, PortNo, QueueId, MinRate).
...
set_queue_max_rate(SwitchId, PortNo, QueueId, MaxRate) ->
    linc_us5_queue:set_max_rate(SwitchId, PortNo, QueueId, MaxRate).

-spec get_ports(integer()) -> list(#port{}).
get_ports(SwitchId) ->
    PortsStates = linc_us5_port:get_all_ports_state(SwitchId),
...
get_port_config(SwitchId, PortNo) ->
    Config = linc_us5_port:get_config(SwitchId, PortNo),
...
get_port_features(SwitchId, PortNo) ->
    {Current, Advertised,
     Supported, Peer} = linc_us5_port:get_features(SwitchId, PortNo),
...
get_queues(SwitchId) ->
    lists:map(fun({ResourceId, QueueId, PortNo, MinRate, MaxRate}) ->
              ...
              end, linc_us5_port:get_all_queues_state(SwitchId)).
